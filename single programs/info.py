...
Label(root, text="Versione programma: 0.2.5", font=('verdana', 10)).place(height=20, x=0, y=25)
Label(root, text="Questo programma è stato ideato per fare calcoli di: \nMatematica di Base, Algebra, Geometria, Fisica.", font=('verdana', 10)).place(height=40, x=1, y=45)
